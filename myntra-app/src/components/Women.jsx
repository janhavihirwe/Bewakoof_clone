...
function Women() {
  ...
  useEffect(() => {
    fetch('https://bewakoof-clone-1.onrender.com/product/category/women')
  ...
  const uniqueFits = [...new Set(products.flatMap(product => product.fit).filter(fit => fit))];
      ...
      <Box padding="4">
        <Breadcrumb spacing="8px" separator="/">
          ...
          <BreadcrumbItem isCurrentPage>
            <BreadcrumbLink href="/women">Women clothing</BreadcrumbLink>
          </BreadcrumbItem>
        </Breadcrumb>
      </Box>
        <Grid templateColumns="1fr 3fr">
          <Box marginTop="20px" >
            <Text fontWeight="bold" fontSize='2xl'>Clothes for Women: {filteredProducts.length}</Text>
